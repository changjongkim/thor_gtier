...
| item | **gtier** | cufile | pread+copy | mmap-cpu | uvm | mmap-gpu |
|---:|---:|---:|---:|---:|---:|---:|
...
- **전송 메커니즘의 우위는 좁다.** 실제 트레이스에서 gTier는 cuFile 대비 1.13~1.27x다.
  "훨씬 빠른 시스템"이 아니다. 레버리지는 전송이 아니라 상주(240x)와 입도(10~20x)에 있다.
